...
public class devis extends javax.swing.JFrame {
    ...
    public devis() {
      ...
      private void updateCombo(){
       ...
       private void updatetxtdevis(){
           ...
           rs = db.exécutionQuery("SELECT MAX(num_devis) AS max_num_devis FROM devis");
            try {
           while(rs.next())
            {
                int num = rs.getInt("max_num_devis");
                int inc=num+1;
                txtdevis.setText(valueOf(inc));

}
          //  rs.next();
          //  txtdevis.setText(rs.getString("max_num_devis"));
        } catch (SQLException ex) {
            Logger.getLogger(devis.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void importer() {
        String colon[] = {"num_devis","code_produit","CodeClient","reference","tvaD","prix_vente","stock_sortie","Ttotal"};
        rs = db.fcSelectCommand(colon, "devis", "num_devis='" + txtdevis.getText() + "'");
    ...
    private void initComponents() {
        ...
        txtdevis = new javax.swing.JTextField();
        ...
        jLabel14.setText("Date Devis");
        jPanel3.add(jLabel14);
        jLabel14.setBounds(330, 170, 90, 30);

        txtdevis.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtdevisActionPerformed(evt);
            }
        });
        jPanel3.add(txtdevis);
        txtdevis.setBounds(110, 170, 120, 30);
        ...
        tbl_ven.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "num_devis", "code_produit", "reference", "Prix de vente", "Quantité", "Ttotal "
            }
        ) {
  ...
  // PreparedStatement pst;
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     try {
             ...
             JasperDesign jdesign = JRXmlLoader.load("B:\\1ere TIC\\JavaProjet\\Gestion_Vente\\Gestion_Vente\\src\\GestionVente\\Devis.jrxml");
          String query ="select * from devis,societe where devis.num_devis='" + txtdevis.getText() + "'";
...
// TODO add your handling code here:
    ...
    private void txtdevisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtdevisActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtdevisActionPerformed
    ...
    private void AjouterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AjouterActionPerformed
        ...
        if (txtcod.getText().equals("") || txtref.getText().equals("") || txtran.getText().equals("")
            ...
            String[] colon = {"num_devis","code_produit","CodeClient", "reference","tvaD", "prix_vente", "stock_sortie", "Ttotal","DateDevis"};
            
            String[] SauDevis = {txtdevis.getText(), txtcod.getText(),jComboBox1.getSelectedItem().toString(), txtref.getText(),txtTVA.getText(), txtnou.getText(), txtsto.getText(), lbltot1.getText(),formater.format(jXDatePicker1.getDate())};
            System.out.println(db.queryInsert("devis", colon, SauDevis));
            try {
                if (!test_stock()) { 
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        String invoice = txtdevis.getText();
        if (JOptionPane.showConfirmDialog(this,"est ce que tu es sure que tu veux supprimer ","attention", JOptionPane.OK_CANCEL_OPTION) == JOptionPane.OK_OPTION) {
            db.queryDelete("devis", "num_devis=" + invoice);
        } else {
            return;
        }
        importer();
 ...
 subtotal();        // TODO add your handling code here:
    ...
    public void cout() {
     ...
     public void subtotal() {
      ...
      public void total() {
        rs = db.exécutionQuery("SELECT SUM(Ttotal) as Ttotal FROM devis WHERE num_devis = '" + txtdevis.getText() + "'");
        try {
            rs.next();
    ...
    public static javax.swing.JTextField txtdevis;
